...
#define OVL_PING_REQU_SIZE               (OVL_COOKIE_SIZE+OVL_HASH_SIZE+1)
#define OVL_PING_RESP_SIZE               OVL_PING_REQU_SIZE
#define OVL_FIND_NODE_MIN_REQU_SIZE      (OVL_COOKIE_SIZE+2*OVL_HASH_SIZE+1)
#define OVL_FIND_NODE_MIN_RESP_SIZE      (OVL_COOKIE_SIZE+1)
#define OVL_FIND_NEIGHBOR_MIN_REQU_SIZE  (OVL_COOKIE_SIZE+2*OVL_HASH_SIZE+1)
#define OVL_FIND_NEIGHBOR_MIN_RESP_SIZE  (OVL_COOKIE_SIZE+1)
